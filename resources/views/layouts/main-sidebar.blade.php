<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a style="font-size:35px;" class="desktop-logo logo-light active d-inline text-dark"  href="{{ url('/' . $page='home') }}"> مساهم <img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="main-logo  d-inline" alt="logo">  </a>
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/avatar/'. Auth::user()->Avatar)}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item" href="{{ url('/' . $page='invoices/Partial') }}">الفواتير المدفوعة جزئيا</a></li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                        <li><a class="slide-item" href="{{ url('/' . $page='invoices/unpaid') }}">الفواتير الغير مدفوعة</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
                ...
                @endcan
                    ...
                    @can('تقرير الفواتير')
                    <li><a class="slide-item" href="{{ url('/' . $page='invoices-report') }}">تقارير الفواتير</a></li>
                    @endcan
                    @can('تقرير العملاء')
                    <li><a class="slide-item" href="{{ url('/' . $page='customers-report') }}">تقارير العملاء</a></li>
                    @endcan
						</ul>
					</li>
                    @endcan
