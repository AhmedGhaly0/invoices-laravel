                        ...
                        <tbody>
                            ...
                            @endphp
                                <tr>
                                    ...
                                    <td class="text-left">
                                        @if ($user->Status == 'مفعل')
                                            <span class="label text-success mr-5  d-flex">
                                                <div class="dot-label bg-success ml-1"></div>{{ $user->Status }}
                                            </span>
                                        @else
                                            <span class="label text-danger mr-5 d-flex">
                                    ...
                                    <td>
                                        ...
                                        @can('حذف مستخدم')
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                ...
                                                data-toggle="modal" href="#delete-user" title="حذف"><i
