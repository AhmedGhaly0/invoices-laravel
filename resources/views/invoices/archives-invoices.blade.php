...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class=" mt-1 tx-13 mr-2 mb-0">/
                      أرشيف الفواتير</span>
            </div>
        </div>
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"> ألغاء ألارشفة</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>

            <form action="{{Route('invoice.restor')}}" method="post">

                @csrf
        </div>
        <div class="modal-body">
            هل انت متاكد من ألغاء أرشفة الفاتورة ؟
            <input type="hidden" name="id" id="id" value="">
