...
@endsection
@section('title', 'أضافة فاتورة - مساهم');
                ...
                <div class="card-body">
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                {{-- <li class="text-center" style="list-style:none; ">
                                    <i class="fas fa-exclamation-triangle ml-1"></i>{{ $error }}
                                </li> --}}
                            </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-success-gradient pl-5 pr-5"> حفظ البيانات </button>
                        </div>
